...
var _tiziano88$elm_oauth$OAuth$getCodeFromQuery = function (loc) {
	var params = _tiziano88$elm_oauth$OAuth$parseUrlParams(loc.search);
	return A2(
		_elm_lang$core$Maybe$withDefault,
		'',
		A2(_elm_lang$core$Dict$get, 'code', params));
};
var _tiziano88$elm_oauth$OAuth$getTokenFromHash = function (loc) {
	var params = _tiziano88$elm_oauth$OAuth$parseUrlParams(loc.hash);
	return A2(
		_elm_lang$core$Maybe$withDefault,
		'',
...
var _tiziano88$elm_oauth$OAuth$buildTokenUrl = F2(
	function (client, code) {
		return A2(
			...
			{
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'grant_type', _1: 'authorization_code'},
				_1: {
					ctor: '::',
...
var _tiziano88$elm_oauth$OAuth$ServerConfig = F3(
	function (a, b, c) {
		return {authorizeUrl: a, tokenUrl: b, validateUrl: c};
	});
var _tiziano88$elm_oauth$OAuth$ClientConfig = F4(
	function (a, b, c, d) {
		return {clientId: a, scopes: b, redirectUrl: c, authFlow: d};
	});
var _tiziano88$elm_oauth$OAuth$Client = F2(
	function (a, b) {
		return {serverConfig: a, clientConfig: b};
	});
var _tiziano88$elm_oauth$OAuth$AccessTokenResponse = F3(
	function (a, b, c) {
		return {accessToken: a, tokenType: b, expiresIn: c};
	});
var _tiziano88$elm_oauth$OAuth$accessTokenResponseDecoder = A4(
	_elm_lang$core$Json_Decode$map3,
	_tiziano88$elm_oauth$OAuth$AccessTokenResponse,
	...
	function (client, token) {
		return A2(
			...
			function (r) {
				...
				if (_p4.ctor === 'Ok') {
					return _elm_lang$core$Result$Ok(
						_tiziano88$elm_oauth$OAuth$Validated(token));
				} else {
...
var _tiziano88$elm_oauth$OAuth$exchangeCode = F2(
	function (client, code) {
		return A2(
			_elm_lang$http$Http$send,
			function (r) {
				...
				if (_p5.ctor === 'Ok') {
					return _elm_lang$core$Result$Ok(
						_tiziano88$elm_oauth$OAuth$Validated(_p5._0.accessToken));
				} else {
			...
			A3(
				...
				A2(_tiziano88$elm_oauth$OAuth$buildTokenUrl, client, code),
				_elm_lang$http$Http$emptyBody,
				_tiziano88$elm_oauth$OAuth$accessTokenResponseDecoder));
	});
var _tiziano88$elm_oauth$OAuth$init = function (client) {
	var _p6 = client.clientConfig.authFlow;
	if (_p6.ctor === 'Implicit') {
		return function (_p7) {
			return A2(
				_tiziano88$elm_oauth$OAuth$validateToken,
				client,
				_tiziano88$elm_oauth$OAuth$getTokenFromHash(_p7));
		};
	} else {
		return function (_p8) {
			return A2(
				_tiziano88$elm_oauth$OAuth$exchangeCode,
				client,
				_tiziano88$elm_oauth$OAuth$getCodeFromQuery(_p8));
		};
	}
};
var _tiziano88$elm_oauth$OAuth$Implicit = {ctor: 'Implicit'};
var _tiziano88$elm_oauth$OAuth$AuthorizationCode = {ctor: 'AuthorizationCode'};

var _martin_kolinek$elm_dashboard$Calendar$viewItem = function (_p0) {
	var _p1 = _p0;
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('calendar-item'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('calendar-time'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(
						A2(_justinmimbs$elm_date_extra$Date_Extra$toFormattedString, 'EEE, MMM dd, HH:mm', _p1.startDate)),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
...
var _martin_kolinek$elm_dashboard$Calendar$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('calendar dashboard-item'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			...
			_1: function () {
				var _p2 = model.calendar;
				if (_p2.ctor === 'CalendarItems') {
					return A2(
						_elm_lang$core$List$map,
						_martin_kolinek$elm_dashboard$Calendar$viewItem,
						A2(_elm_lang$core$List$take, 8, _p2._0));
				} else {
					return {
						ctor: '::',
...
var _martin_kolinek$elm_dashboard$Calendar$dateDecoder = A2(
	_elm_lang$core$Json_Decode$andThen,
	function (x) {
		var _p3 = _justinmimbs$elm_date_extra$Date_Extra$fromIsoString(
			A2(_elm_lang$core$Basics_ops['++'], x, 'Z'));
		if (_p3.ctor === 'Just') {
			return _elm_lang$core$Json_Decode$succeed(_p3._0);
		} else {
			return _elm_lang$core$Json_Decode$fail('Not a valid date');
		}
	},
	_elm_lang$core$Json_Decode$string);
var _martin_kolinek$elm_dashboard$Calendar$createQueryParams = function (date) {
	return {
		ctor: '::',
		_0: {
			ctor: '_Tuple2',
			_0: 'StartDateTime',
			_1: _justinmimbs$elm_date_extra$Date_Extra$toUtcIsoString(date)
		},
		_1: {
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'EndDateTime',
				_1: _justinmimbs$elm_date_extra$Date_Extra$toUtcIsoString(
					A3(_justinmimbs$elm_date_extra$Date_Extra$add, _justinmimbs$elm_date_extra$Date_Extra$Week, 2, date))
			},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: '$orderBy', _1: 'start/dateTime'},
				_1: {ctor: '[]'}
			}
		}
	};
};
var _martin_kolinek$elm_dashboard$Calendar$microsoftAuthClient = A2(
	_tiziano88$elm_oauth$OAuth$newClient,
	{authorizeUrl: 'https://login.microsoftonline.com/common/oauth2/v2.0/authorize', tokenUrl: '', validateUrl: ''},
	{
...
var _martin_kolinek$elm_dashboard$Calendar$microsoftAuthorize = _elm_lang$navigation$Navigation$load(
	_tiziano88$elm_oauth$OAuth$buildAuthUrl(_martin_kolinek$elm_dashboard$Calendar$microsoftAuthClient));
var _martin_kolinek$elm_dashboard$Calendar$Model = F2(
	function (a, b) {
		return {microsoftOAuthToken: a, calendar: b};
	});
var _martin_kolinek$elm_dashboard$Calendar$CalendarItem = F2(
	function (a, b) {
		return {startDate: a, title: b};
	});
var _martin_kolinek$elm_dashboard$Calendar$calendarItemsDecoder = A2(
	_elm_lang$core$Json_Decode$field,
	'value',
	_elm_lang$core$Json_Decode$list(
		A3(
			_elm_lang$core$Json_Decode$map2,
			_martin_kolinek$elm_dashboard$Calendar$CalendarItem,
			A2(
				_elm_lang$core$Json_Decode$field,
				'start',
				A2(_elm_lang$core$Json_Decode$field, 'dateTime', _martin_kolinek$elm_dashboard$Calendar$dateDecoder)),
			A2(_elm_lang$core$Json_Decode$field, 'subject', _elm_lang$core$Json_Decode$string))));
var _martin_kolinek$elm_dashboard$Calendar$loadCalendarTask = F2(
	function (model, currentDate) {
		var _p4 = model.microsoftOAuthToken;
		return _lukewestby$elm_http_builder$HttpBuilder$toTask(
			A2(
				_lukewestby$elm_http_builder$HttpBuilder$withExpect,
				_elm_lang$http$Http$expectJson(_martin_kolinek$elm_dashboard$Calendar$calendarItemsDecoder),
				A3(
					...
					A2(
						_lukewestby$elm_http_builder$HttpBuilder$withQueryParams,
						_martin_kolinek$elm_dashboard$Calendar$createQueryParams(currentDate),
						_lukewestby$elm_http_builder$HttpBuilder$get('https://graph.microsoft.com/v1.0/me/calendarView')))));
	});
var _martin_kolinek$elm_dashboard$Calendar$CalendarError = function (a) {
	return {ctor: 'CalendarError', _0: a};
};
var _martin_kolinek$elm_dashboard$Calendar$CalendarItems = function (a) {
	return {ctor: 'CalendarItems', _0: a};
};
var _martin_kolinek$elm_dashboard$Calendar$initModel = {
	microsoftOAuthToken: _tiziano88$elm_oauth$OAuth$Validated(''),
	calendar: _martin_kolinek$elm_dashboard$Calendar$CalendarItems(
		{ctor: '[]'})
};
var _martin_kolinek$elm_dashboard$Calendar$RequestMicrosoftAuthorization = {ctor: 'RequestMicrosoftAuthorization'};
var _martin_kolinek$elm_dashboard$Calendar$SetCalendar = function (a) {
	return {ctor: 'SetCalendar', _0: a};
};
var _martin_kolinek$elm_dashboard$Calendar$parseCalendarResponse = function (response) {
	var _p5 = response;
	if (_p5.ctor === 'Ok') {
		return _martin_kolinek$elm_dashboard$Calendar$SetCalendar(
			_martin_kolinek$elm_dashboard$Calendar$CalendarItems(_p5._0));
	} else {
		if (_p5._0.ctor === 'BadStatus') {
			return _elm_lang$core$Native_Utils.eq(_p5._0._0.status.code, 401) ? _martin_kolinek$elm_dashboard$Calendar$RequestMicrosoftAuthorization : _martin_kolinek$elm_dashboard$Calendar$SetCalendar(
				_martin_kolinek$elm_dashboard$Calendar$CalendarError(
...
var _martin_kolinek$elm_dashboard$Calendar$loadCalendar = function (model) {
	return A2(
		_elm_lang$core$Task$attempt,
		_martin_kolinek$elm_dashboard$Calendar$parseCalendarResponse,
		A2(
			_elm_lang$core$Task$andThen,
			_martin_kolinek$elm_dashboard$Calendar$loadCalendarTask(model),
			_elm_lang$core$Date$now));
};
var _martin_kolinek$elm_dashboard$Calendar$update = F2(
	function (msg, model) {
		var _p6 = msg;
		switch (_p6.ctor) {
			case 'MicrosoftAuthorize':
				var newModel = _elm_lang$core$Native_Utils.update(
					model,
					{microsoftOAuthToken: _p6._0});
				return {
					ctor: '_Tuple2',
					_0: newModel,
					_1: _martin_kolinek$elm_dashboard$Calendar$loadCalendar(newModel)
				};
			case 'SetCalendar':
				return {
					ctor: '_Tuple2',
			...
			default:
				return {ctor: '_Tuple2', _0: model, _1: _martin_kolinek$elm_dashboard$Calendar$microsoftAuthorize};
		}
	});
var _martin_kolinek$elm_dashboard$Calendar$MicrosoftAuthorize = function (a) {
	return {ctor: 'MicrosoftAuthorize', _0: a};
};
var _martin_kolinek$elm_dashboard$Calendar$authResultToCmd = function (result) {
	var _p7 = result;
	if (_p7.ctor === 'Err') {
		return _martin_kolinek$elm_dashboard$Calendar$RequestMicrosoftAuthorization;
	} else {
		return _martin_kolinek$elm_dashboard$Calendar$MicrosoftAuthorize(_p7._0);
	}
};
var _martin_kolinek$elm_dashboard$Calendar$initCmd = function (location) {
	return A2(
		_elm_lang$core$Platform_Cmd$map,
		_martin_kolinek$elm_dashboard$Calendar$authResultToCmd,
		A2(_tiziano88$elm_oauth$OAuth$init, _martin_kolinek$elm_dashboard$Calendar$microsoftAuthClient, location));
};

var _martin_kolinek$elm_dashboard$Clock$view = function (_p0) {
	var _p1 = _p0;
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('clock dashboard-item'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(
						A2(_justinmimbs$elm_date_extra$Date_Extra$toFormattedString, 'HH:mm:ss', _p2)),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(
							A2(_justinmimbs$elm_date_extra$Date_Extra$toFormattedString, 'EEE, MMMM ddd yyyy', _p2)),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _martin_kolinek$elm_dashboard$Clock$update = F2(
	function (msg, model) {
		var _p3 = msg;
		return {
			ctor: '_Tuple2',
...
var _martin_kolinek$elm_dashboard$Clock$initModel = {
	currentDate: _elm_lang$core$Date$fromTime(0)
};
var _martin_kolinek$elm_dashboard$Clock$Model = function (a) {
	return {currentDate: a};
};
var _martin_kolinek$elm_dashboard$Clock$UpdateDate = function (a) {
	return {ctor: 'UpdateDate', _0: a};
};
var _martin_kolinek$elm_dashboard$Clock$initCmd = A2(_elm_lang$core$Task$perform, _martin_kolinek$elm_dashboard$Clock$UpdateDate, _elm_lang$core$Date$now);
var _martin_kolinek$elm_dashboard$Clock$subscriptions = A2(
	_elm_lang$core$Time$every,
	_elm_lang$core$Time$second,
	function (_p4) {
		return _martin_kolinek$elm_dashboard$Clock$UpdateDate(
			_elm_lang$core$Date$fromTime(_p4));
	});

var _martin_kolinek$elm_dashboard$LocalStorage$saveDismissedNews = _elm_lang$core$Native_Platform.outgoingPort(
	'saveDismissedNews',
	function (v) {
...
var _martin_kolinek$elm_dashboard$LocalStorage$loadDismissedNews = _elm_lang$core$Native_Platform.outgoingPort(
	'loadDismissedNews',
	function (v) {
		return null;
	});
var _martin_kolinek$elm_dashboard$LocalStorage$dismissedNews = _elm_lang$core$Native_Platform.incomingPort(
	'dismissedNews',
	_elm_lang$core$Json_Decode$list(
		A2(
			_elm_lang$core$Json_Decode$andThen,
...
var _martin_kolinek$elm_dashboard$LocalStorage$saveNotes = _elm_lang$core$Native_Platform.outgoingPort(
	'saveNotes',
	function (v) {
		return _elm_lang$core$Native_List.toArray(v).map(
			function (v) {
				return {id: v.id, currentlyEditing: v.currentlyEditing, content: v.content};
			});
	});
var _martin_kolinek$elm_dashboard$LocalStorage$loadNotes = _elm_lang$core$Native_Platform.outgoingPort(
	'loadNotes',
	function (v) {
		return null;
	});
var _martin_kolinek$elm_dashboard$LocalStorage$loadedNotes = _elm_lang$core$Native_Platform.incomingPort(
	'loadedNotes',
	_elm_lang$core$Json_Decode$list(
		A2(
			_elm_lang$core$Json_Decode$andThen,
				...
				return A2(
					...
					function (currentlyEditing) {
						return A2(
							...
							function (content) {
								return _elm_lang$core$Json_Decode$succeed(
									{id: id, currentlyEditing: currentlyEditing, content: content});
							},
							A2(_elm_lang$core$Json_Decode$field, 'content', _elm_lang$core$Json_Decode$string));
					},
					A2(_elm_lang$core$Json_Decode$field, 'currentlyEditing', _elm_lang$core$Json_Decode$bool));
			},
			A2(_elm_lang$core$Json_Decode$field, 'id', _elm_lang$core$Json_Decode$int))));
var _martin_kolinek$elm_dashboard$LocalStorage$Note = F3(
	function (a, b, c) {
		return {id: a, currentlyEditing: b, content: c};
	});

var _martin_kolinek$elm_dashboard$News$findVisibleNews = F2(
	function (newsItems, dismissedNews) {
		return A2(
				...
				A2(
					...
					function (x) {
						return !A2(
							...
							{ctor: '_Tuple2', _0: x.category, _1: x.id},
							dismissedNews);
					},
					newsItems)));
	});
var _martin_kolinek$elm_dashboard$News$parseDateString = function (str) {
	var rgx = _elm_lang$core$Regex$regex('\\d+');
	var matches = A3(
		_elm_lang$core$Regex$find,
		_elm_lang$core$Regex$AtMost(1),
		rgx,
...
var _martin_kolinek$elm_dashboard$News$updateDismissedNews = F2(
	function (model, newDismissedNews) {
		return {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Native_Utils.update(
				model,
				{dismissedNews: newDismissedNews}),
			_1: _martin_kolinek$elm_dashboard$LocalStorage$saveDismissedNews(
				_elm_lang$core$Set$toList(newDismissedNews))
		};
	});
var _martin_kolinek$elm_dashboard$News$updateCurrentNews = F2(
	function (model, newNews) {
		var _p2 = {ctor: '_Tuple2', _0: model.currentNews, _1: newNews};
		if ((_p2._0.ctor === 'Ok') && (_p2._1.ctor === 'Ok')) {
			var _p3 = _p2._1._0;
			var newKeys = _elm_lang$core$Set$fromList(
				A2(
					_elm_lang$core$List$map,
					function (x) {
						return {ctor: '_Tuple2', _0: x.category, _1: x.id};
					},
					_p3));
			var filteredOldNews = A2(
				_elm_lang$core$List$filter,
				function (x) {
					return !A2(
						_elm_lang$core$Set$member,
			...
			return _elm_lang$core$Native_Utils.update(
				model,
				{
					currentNews: _elm_lang$core$Result$Ok(
						A2(_elm_lang$core$Basics_ops['++'], _p3, filteredOldNews))
				});
		} else {
			return _elm_lang$core$Native_Utils.update(
				model,
...
var _martin_kolinek$elm_dashboard$News$initModel = {
	currentNews: _elm_lang$core$Result$Ok(
		{ctor: '[]'}),
	dismissedNews: _elm_lang$core$Set$empty
};
var _martin_kolinek$elm_dashboard$News$createItemUrl = F2(
	function (category, id) {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			'https://sps2010.erninet.ch/news/',
			A2(
				_elm_lang$core$Basics_ops['++'],
				category,
				A2(
					_elm_lang$core$Basics_ops['++'],
					'/Lists/Posts/ViewPost.aspx?ID=',
					_elm_lang$core$Basics$toString(id))));
	});
var _martin_kolinek$elm_dashboard$News$createFetchUrl = function (category) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'https://sps2010.erninet.ch/news/',
		A2(_elm_lang$core$Basics_ops['++'], category, '/_vti_bin/listdata.svc/Posts()?$top=20&$orderby=Id desc'));
};
var _martin_kolinek$elm_dashboard$News$categories = {
	ctor: '::',
	_0: 'Management',
	_1: {
		ctor: '::',
...
var _martin_kolinek$elm_dashboard$News$NewsItem = F4(
	function (a, b, c, d) {
		return {id: a, category: b, title: c, published: d};
	});
var _martin_kolinek$elm_dashboard$News$newsItemDecoder = function (category) {
	return A5(
		_elm_lang$core$Json_Decode$map4,
		_martin_kolinek$elm_dashboard$News$NewsItem,
		A2(_elm_lang$core$Json_Decode$field, 'Id', _elm_lang$core$Json_Decode$int),
		_elm_lang$core$Json_Decode$succeed(category),
		A2(_elm_lang$core$Json_Decode$field, 'Title', _elm_lang$core$Json_Decode$string),
		A2(
			_elm_lang$core$Json_Decode$field,
			'Published',
			A2(_elm_lang$core$Json_Decode$andThen, _martin_kolinek$elm_dashboard$News$parseDateString, _elm_lang$core$Json_Decode$string)));
};
var _martin_kolinek$elm_dashboard$News$newsItemsDecoder = function (category) {
	return A2(
		_elm_lang$core$Json_Decode$field,
		'd',
		_elm_lang$core$Json_Decode$list(
			_martin_kolinek$elm_dashboard$News$newsItemDecoder(category)));
};
var _martin_kolinek$elm_dashboard$News$Model = F2(
	function (a, b) {
		return {currentNews: a, dismissedNews: b};
	});
var _martin_kolinek$elm_dashboard$News$UpdateDismissedNews = function (a) {
	return {ctor: 'UpdateDismissedNews', _0: a};
};
var _martin_kolinek$elm_dashboard$News$DismissNewsItem = function (a) {
	return {ctor: 'DismissNewsItem', _0: a};
};
var _martin_kolinek$elm_dashboard$News$viewNewsItem = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('news-item'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('news-time'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text(
						A2(_justinmimbs$elm_date_extra$Date_Extra$toFormattedString, 'EEE, MMM dd yyyy', model.published)),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$a,
					{
						...
						_0: _elm_lang$html$Html_Attributes$href(
							A2(_martin_kolinek$elm_dashboard$News$createItemUrl, model.category, model.id)),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$target('_blank'),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$title(model.title),
								_1: {ctor: '[]'}
							}
						}
					},
				...
				_1: {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('dismiss-news'),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(
									_martin_kolinek$elm_dashboard$News$DismissNewsItem(model)),
								_1: {ctor: '[]'}
							}
						},
						{ctor: '[]'}),
...
var _martin_kolinek$elm_dashboard$News$view = function (_p4) {
	var _p5 = _p4;
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('news dashboard-item'),
			_1: {ctor: '[]'}
		},
		function () {
			var _p6 = _p5.currentNews;
			if (_p6.ctor === 'Ok') {
				var _p7 = A2(_martin_kolinek$elm_dashboard$News$findVisibleNews, _p6._0, _p5.dismissedNews);
				if (_p7.ctor === '[]') {
					return {
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('No Recent News'),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					};
					...
					return {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Latest News'),
								_1: {ctor: '[]'}
							}),
						_1: A2(_elm_lang$core$List$map, _martin_kolinek$elm_dashboard$News$viewNewsItem, _p7)
					};
				}
			} else {
				return {
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('news-error'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Unable to Fetch News'),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
...
var _martin_kolinek$elm_dashboard$News$UpdateNews = {ctor: 'UpdateNews'};
var _martin_kolinek$elm_dashboard$News$subscriptions = function (_p8) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: A2(
				_elm_lang$core$Time$every,
				2 * _elm_lang$core$Time$minute,
				_elm_lang$core$Basics$always(_martin_kolinek$elm_dashboard$News$UpdateNews)),
			_1: {
				ctor: '::',
				_0: _martin_kolinek$elm_dashboard$LocalStorage$dismissedNews(_martin_kolinek$elm_dashboard$News$UpdateDismissedNews),
				_1: {ctor: '[]'}
			}
		});
};
var _martin_kolinek$elm_dashboard$News$SetNews = function (a) {
	return {ctor: 'SetNews', _0: a};
};
var _martin_kolinek$elm_dashboard$News$parseResponse = function (response) {
	var _p9 = response;
	if (_p9.ctor === 'Ok') {
		return _martin_kolinek$elm_dashboard$News$SetNews(
			_elm_lang$core$Result$Ok(_p9._0));
	} else {
		switch (_p9._0.ctor) {
			case 'BadUrl':
				return _martin_kolinek$elm_dashboard$News$SetNews(
					_elm_lang$core$Result$Err('Wrong URL for some reason'));
			case 'Timeout':
				return _martin_kolinek$elm_dashboard$News$SetNews(
					_elm_lang$core$Result$Err('Timeout occurred'));
			case 'NetworkError':
				return _martin_kolinek$elm_dashboard$News$SetNews(
					_elm_lang$core$Result$Err('Network error (do you have CorsE enabled?)'));
			case 'BadStatus':
				var _p10 = _p9._0._0.status;
				return _martin_kolinek$elm_dashboard$News$SetNews(
					_elm_lang$core$Result$Err(
						A2(
							...
							A2(
								_elm_lang$core$Basics_ops['++'],
								_elm_lang$core$Basics$toString(_p10.code),
								A2(_elm_lang$core$Basics_ops['++'], ' ', _p10.message)))));
			default:
				return _martin_kolinek$elm_dashboard$News$SetNews(
					_elm_lang$core$Result$Err('Unexpected response format'));
		}
	}
};
var _martin_kolinek$elm_dashboard$News$fetchNews = function (category) {
	return A2(
		_lukewestby$elm_http_builder$HttpBuilder$send,
		_martin_kolinek$elm_dashboard$News$parseResponse,
		A3(
			_lukewestby$elm_http_builder$HttpBuilder$withHeader,
			'Accept',
			'application/json',
			_lukewestby$elm_http_builder$HttpBuilder$withCredentials(
				A2(
					...
					_elm_lang$http$Http$expectJson(
						_martin_kolinek$elm_dashboard$News$newsItemsDecoder(category)),
					_lukewestby$elm_http_builder$HttpBuilder$get(
						_martin_kolinek$elm_dashboard$News$createFetchUrl(category))))));
};
var _martin_kolinek$elm_dashboard$News$initCmd = _elm_lang$core$Platform_Cmd$batch(
	{
		ctor: '::',
		_0: _martin_kolinek$elm_dashboard$LocalStorage$loadDismissedNews(
			{ctor: '_Tuple0'}),
		_1: A2(_elm_lang$core$List$map, _martin_kolinek$elm_dashboard$News$fetchNews, _martin_kolinek$elm_dashboard$News$categories)
	});
var _martin_kolinek$elm_dashboard$News$update = F2(
	function (msg, model) {
		var _p11 = msg;
		switch (_p11.ctor) {
			case 'SetNews':
				return {
					ctor: '_Tuple2',
					_0: A2(_martin_kolinek$elm_dashboard$News$updateCurrentNews, model, _p11._0),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'UpdateNews':
				return {
					...
					_1: _elm_lang$core$Platform_Cmd$batch(
						A2(_elm_lang$core$List$map, _martin_kolinek$elm_dashboard$News$fetchNews, _martin_kolinek$elm_dashboard$News$categories))
				};
			case 'DismissNewsItem':
				return A2(
					_martin_kolinek$elm_dashboard$News$updateDismissedNews,
					model,
					A2(
						_elm_lang$core$Set$insert,
						{ctor: '_Tuple2', _0: _p11._0.category, _1: _p11._0.id},
						model.dismissedNews));
			default:
				return A2(
					_martin_kolinek$elm_dashboard$News$updateDismissedNews,
					...
					A2(
						...
						_elm_lang$core$Set$fromList(_p11._0),
						model.dismissedNews));
		}
	});

var _martin_kolinek$elm_dashboard$Notes$tryChangeContent = F3(
	function (id, str, note) {
		return _elm_lang$core$Native_Utils.eq(note.id, id) ? _elm_lang$core$Native_Utils.update(
			note,
			{content: str}) : note;
	});
var _martin_kolinek$elm_dashboard$Notes$tryChangeEditingStatus = F3(
	function (id, status, note) {
		return _elm_lang$core$Native_Utils.eq(note.id, id) ? _elm_lang$core$Native_Utils.update(
			note,
			{currentlyEditing: status}) : note;
	});
var _martin_kolinek$elm_dashboard$Notes$findNextId = function (model) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		0,
...
var _martin_kolinek$elm_dashboard$Notes$updateNotes = F2(
	function (func, model) {
		var newNotes = func(model.notes);
		return {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Native_Utils.update(
				model,
				{notes: newNotes}),
			_1: _martin_kolinek$elm_dashboard$LocalStorage$saveNotes(newNotes)
		};
	});
var _martin_kolinek$elm_dashboard$Notes$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'UpdateNewNote':
			...
			case 'CreateNote':
				var newNote = {
					id: _martin_kolinek$elm_dashboard$Notes$findNextId(model),
					currentlyEditing: false,
					content: model.newNote
				};
				var _p1 = A2(
					_martin_kolinek$elm_dashboard$Notes$updateNotes,
					function (x) {
						return {ctor: '::', _0: newNote, _1: x};
					},
					model);
				var newModel = _p1._0;
				var cmd = _p1._1;
			...
			case 'StartEditing':
				return A2(
					_martin_kolinek$elm_dashboard$Notes$updateNotes,
					_elm_lang$core$List$map(
						A2(_martin_kolinek$elm_dashboard$Notes$tryChangeEditingStatus, _p0._0, true)),
					model);
			case 'EndEditing':
				return A2(
					_martin_kolinek$elm_dashboard$Notes$updateNotes,
					_elm_lang$core$List$map(
						A2(_martin_kolinek$elm_dashboard$Notes$tryChangeEditingStatus, _p0._0, false)),
					model);
			case 'UpdateNote':
				return A2(
					_martin_kolinek$elm_dashboard$Notes$updateNotes,
					_elm_lang$core$List$map(
						A2(_martin_kolinek$elm_dashboard$Notes$tryChangeContent, _p0._0, _p0._1)),
					model);
			default:
				return {
					ctor: '_Tuple2',
...
var _martin_kolinek$elm_dashboard$Notes$initCmd = _martin_kolinek$elm_dashboard$LocalStorage$loadNotes(
	{ctor: '_Tuple0'});
var _martin_kolinek$elm_dashboard$Notes$initModel = {
	notes: {ctor: '[]'},
	newNote: ''
};
var _martin_kolinek$elm_dashboard$Notes$Model = F2(
	function (a, b) {
		return {notes: a, newNote: b};
	});
var _martin_kolinek$elm_dashboard$Notes$LoadNotes = function (a) {
	return {ctor: 'LoadNotes', _0: a};
};
var _martin_kolinek$elm_dashboard$Notes$subscriptions = _martin_kolinek$elm_dashboard$LocalStorage$loadedNotes(_martin_kolinek$elm_dashboard$Notes$LoadNotes);
var _martin_kolinek$elm_dashboard$Notes$UpdateNote = F2(
	function (a, b) {
		return {ctor: 'UpdateNote', _0: a, _1: b};
	});
var _martin_kolinek$elm_dashboard$Notes$DeleteNote = function (a) {
	return {ctor: 'DeleteNote', _0: a};
};
var _martin_kolinek$elm_dashboard$Notes$CreateNote = {ctor: 'CreateNote'};
var _martin_kolinek$elm_dashboard$Notes$UpdateNewNote = function (a) {
	return {ctor: 'UpdateNewNote', _0: a};
};
var _martin_kolinek$elm_dashboard$Notes$EndEditing = function (a) {
	return {ctor: 'EndEditing', _0: a};
};
var _martin_kolinek$elm_dashboard$Notes$StartEditing = function (a) {
	return {ctor: 'StartEditing', _0: a};
};
var _martin_kolinek$elm_dashboard$Notes$viewNote = function (_p2) {
	var _p3 = _p2;
	var _p5 = _p3.id;
	var _p4 = _p3.content;
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('dashboard-item note'),
			_1: {ctor: '[]'}
		},
		_p3.currentlyEditing ? {
			ctor: '::',
			_0: A2(
				_elm_lang$html$Html$textarea,
				{
					...
					_0: _elm_lang$html$Html_Events$onInput(
						_martin_kolinek$elm_dashboard$Notes$UpdateNote(_p5)),
					_1: {
						ctor: '::',
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('done'),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(
								_martin_kolinek$elm_dashboard$Notes$EndEditing(_p5)),
							_1: {ctor: '[]'}
						}
					},
					{
			...
			_0: A2(
				_elm_lang$html$Html$div,
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onClick(
							_martin_kolinek$elm_dashboard$Notes$StartEditing(_p5)),
						_1: {ctor: '[]'}
					}
				},
				{ctor: '[]'}),
				...
				_0: A2(
					_elm_lang$html$Html$div,
					{
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onClick(
								_martin_kolinek$elm_dashboard$Notes$DeleteNote(_p5)),
							_1: {ctor: '[]'}
						}
					},
					{ctor: '[]'}),
...
var _martin_kolinek$elm_dashboard$Notes$view = function (_p6) {
	var _p7 = _p6;
	return A2(
		_elm_lang$html$Html$div,
		{
		...
		},
		{
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onInput(_martin_kolinek$elm_dashboard$Notes$UpdateNewNote),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$value(_p7.newNote),
								_1: {ctor: '[]'}
							}
						},
						{ctor: '[]'}),
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Events$onClick(_martin_kolinek$elm_dashboard$Notes$CreateNote),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
			...
			_1: A2(_elm_lang$core$List$map, _martin_kolinek$elm_dashboard$Notes$viewNote, _p7.notes)
		});
};

var _martin_kolinek$elm_dashboard$Main$initModel = {clock: _martin_kolinek$elm_dashboard$Clock$initModel, news: _martin_kolinek$elm_dashboard$News$initModel, calendar: _martin_kolinek$elm_dashboard$Calendar$initModel, notes: _martin_kolinek$elm_dashboard$Notes$initModel};
var _martin_kolinek$elm_dashboard$Main$Model = F4(
	function (a, b, c, d) {
		return {clock: a, news: b, calendar: c, notes: d};
	});
var _martin_kolinek$elm_dashboard$Main$NotesMsg = function (a) {
	return {ctor: 'NotesMsg', _0: a};
};
var _martin_kolinek$elm_dashboard$Main$LocationChange = {ctor: 'LocationChange'};
var _martin_kolinek$elm_dashboard$Main$CalendarMsg = function (a) {
	return {ctor: 'CalendarMsg', _0: a};
};
var _martin_kolinek$elm_dashboard$Main$NewsMsg = function (a) {
	return {ctor: 'NewsMsg', _0: a};
};
var _martin_kolinek$elm_dashboard$Main$ClockMsg = function (a) {
	return {ctor: 'ClockMsg', _0: a};
};
var _martin_kolinek$elm_dashboard$Main$init = function (location) {
	return {
		ctor: '_Tuple2',
		_0: _martin_kolinek$elm_dashboard$Main$initModel,
		_1: _elm_lang$core$Platform_Cmd$batch(
			{
				ctor: '::',
				_0: A2(_elm_lang$core$Platform_Cmd$map, _martin_kolinek$elm_dashboard$Main$ClockMsg, _martin_kolinek$elm_dashboard$Clock$initCmd),
				_1: {
					ctor: '::',
					_0: A2(_elm_lang$core$Platform_Cmd$map, _martin_kolinek$elm_dashboard$Main$NewsMsg, _martin_kolinek$elm_dashboard$News$initCmd),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$core$Platform_Cmd$map,
							_martin_kolinek$elm_dashboard$Main$CalendarMsg,
							_martin_kolinek$elm_dashboard$Calendar$initCmd(location)),
						_1: {
							ctor: '::',
							_0: A2(_elm_lang$core$Platform_Cmd$map, _martin_kolinek$elm_dashboard$Main$NotesMsg, _martin_kolinek$elm_dashboard$Notes$initCmd),
							_1: {ctor: '[]'}
						}
					}
				}
...
var _martin_kolinek$elm_dashboard$Main$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'ClockMsg':
				var _p1 = A2(_martin_kolinek$elm_dashboard$Clock$update, _p0._0, model.clock);
				var clockModel = _p1._0;
				var clockCmd = _p1._1;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{clock: clockModel}),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _martin_kolinek$elm_dashboard$Main$ClockMsg, clockCmd)
				};
			case 'CalendarMsg':
				var _p2 = A2(_martin_kolinek$elm_dashboard$Calendar$update, _p0._0, model.calendar);
				var calModel = _p2._0;
				var calCmd = _p2._1;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{calendar: calModel}),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _martin_kolinek$elm_dashboard$Main$CalendarMsg, calCmd)
				};
			case 'NewsMsg':
				var _p3 = A2(_martin_kolinek$elm_dashboard$News$update, _p0._0, model.news);
				var newsModel = _p3._0;
				var newsCmd = _p3._1;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{news: newsModel}),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _martin_kolinek$elm_dashboard$Main$NewsMsg, newsCmd)
				};
			case 'NotesMsg':
				var _p4 = A2(_martin_kolinek$elm_dashboard$Notes$update, _p0._0, model.notes);
				var notesModel = _p4._0;
				var notesCmd = _p4._1;
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{notes: notesModel}),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _martin_kolinek$elm_dashboard$Main$NotesMsg, notesCmd)
				};
			default:
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
		}
	});
var _martin_kolinek$elm_dashboard$Main$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('dashboard-side'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A2(
						...
						_martin_kolinek$elm_dashboard$Main$ClockMsg,
						_martin_kolinek$elm_dashboard$Clock$view(model.clock)),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$map,
							_martin_kolinek$elm_dashboard$Main$CalendarMsg,
							_martin_kolinek$elm_dashboard$Calendar$view(model.calendar)),
						_1: {
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$map,
								_martin_kolinek$elm_dashboard$Main$NewsMsg,
								_martin_kolinek$elm_dashboard$News$view(model.news)),
							_1: {ctor: '[]'}
						}
					}
				}),
			_1: {
				...
				_0: A2(
					_elm_lang$html$Html$map,
					_martin_kolinek$elm_dashboard$Main$NotesMsg,
					_martin_kolinek$elm_dashboard$Notes$view(model.notes)),
				_1: {ctor: '[]'}
			}
		});
};
var _martin_kolinek$elm_dashboard$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: A2(_elm_lang$core$Platform_Sub$map, _martin_kolinek$elm_dashboard$Main$ClockMsg, _martin_kolinek$elm_dashboard$Clock$subscriptions),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$core$Platform_Sub$map,
					_martin_kolinek$elm_dashboard$Main$NewsMsg,
					_martin_kolinek$elm_dashboard$News$subscriptions(model.news)),
				_1: {
					ctor: '::',
					_0: A2(_elm_lang$core$Platform_Sub$map, _martin_kolinek$elm_dashboard$Main$NotesMsg, _martin_kolinek$elm_dashboard$Notes$subscriptions),
					_1: {ctor: '[]'}
				}
			}
		});
};
var _martin_kolinek$elm_dashboard$Main$main = A2(
	_elm_lang$navigation$Navigation$program,
	_elm_lang$core$Basics$always(_martin_kolinek$elm_dashboard$Main$LocationChange),
	{init: _martin_kolinek$elm_dashboard$Main$init, view: _martin_kolinek$elm_dashboard$Main$view, update: _martin_kolinek$elm_dashboard$Main$update, subscriptions: _martin_kolinek$elm_dashboard$Main$subscriptions})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _martin_kolinek$elm_dashboard$Main$main !== 'undefined') {
    _martin_kolinek$elm_dashboard$Main$main(Elm['Main'], 'Main', undefined);
}
